...
<div style="float:right; clear:right; width:260px; margin:0 0 0 14; border-collapse:collapse">
  ...
  <span align="center" style="float:right; clear:right; width:260px; margin:0 0 0 14; padding:4 0 0 0; border:2px solid #666; border-collapse:collapse">![[Corstaea flag.png|250]]<br>![[Corstaea (Region).jpg|250]]</span>
  ...
  <div style="float:right; clear:right; width:260px; margin:0 0 0 14; border-collapse:collapse">
    <table style="float:right; clear:right; width:260px; margin:0 0 7 14; border:2px solid #666; border-top:1px solid #666; line-height:1.5; border-collapse:collapse; font-size:smaller">
		...
		<tr style="border-bottom:1px solid #666; border-top:2px solid #666">
			...
			<td style="padding:4px">Democratic Federation of Corstaea</td>
		</tr>
		
		<tr style="border-bottom:1px solid #666">
			<td style="padding:4px"><b>Demonym</b></td>
			<td style="padding:4px">Corstaean</td>
		</tr>
	
		<tr style="border-bottom:1px solid #666">
			<td style="padding:4px"><b>Motto</b></td>
			<td style="padding:4px">From the sea, life. From life, Progress</td>
		</tr>
		...
		<tr style="border-bottom:1px solid #666">
			...
			<td style="padding:4px">Østerlund</td>
		</tr>
		
		<tr style="border-bottom:1px solid #666">
			<td style="padding:4px"><b>Government</b></td>
			<td style="padding:4px">Parliamentary democracy</td>
		</tr>
	
		<tr style="border-bottom:1px solid #666">
			<td style="padding:4px"><b>Currency</b></td>
			<td style="padding:4px">Krone - kr (CKR)<br>1 CR = ~0.019 kr</td>
		</tr>
	
		<tr style="border-bottom:1px solid #666">
			<td style="padding:4px"><b>GDP</b></td>
			<td style="padding:4px">292.3 trillion CR/yr</td>
		</tr>
	
		<tr style="border-bottom:1px solid #666">
			<td style="padding:4px"><b>Population</b></td>
			<td style="padding:4px">~238,000,000</td>
		</tr>
		...
		<tr style="border-bottom:1px solid #666">
			...
			<td style="padding:4px">Edelweiss</td>
		</tr>
